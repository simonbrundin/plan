...
- [ ] ´simon cluster health´ grönt
  ...
  - [ ] Longhorn rapporterar grönt
    ...
    - [ ] ´simon kubernetes longhorn test´ för alla noder och se till att allt
      - [x] Systemdisk blir grönt när konfiguerad serial är samma som
            installerad är grönt
      - [ ] Extensions visar iscsi-tools och inte schematic
  - [ ] Uppdatera istallationsguide för en ny nod eller disk så rätt serial
        läggs till i patchen
