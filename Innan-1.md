...
- [ ] Installera Talos på datorer
  - [x] Mac Mini
  - [ ] HP
- [x] Alla Talos noder fungerar och är inkopplade
  - [x] Ping av pxe och talos noder fungerar
- [x] Ping av pxe och talos noder fungerar
- [ ] Dot AI
- [ ] ArgoCD fungerar
- [ ] Teleport fungerar
...
Länk som öppnar ephemeral environment så jag kan reviewa förändringen

### Få fyndmejl

- [x] Marknadsplatser att hämta annonser ifrån
  - [ ] Tradera annonser hämtas som har
    - [x] Gör så den scrapar från min ip först till den når max. sedan kör evomi
    - [ ] Turodning
      - [ ] Eget api
  - [ ] Ebay
  - [ ] Vinted
  - [ ] Lego
- [ ] Nya värderinsmetoder
  - [ ] Värderingsmetod - Egen databas
  - [ ] Värderingsmetod - Refurbed eller liknande
  - [ ] Värderingsmetod - Ebayförsäljningar
  - [ ] Värderingsmetod - Marketplaceförsäljningar

### Köp

- [ ] Skapa traded_items X listings tabell
- [ ] Inventatirekatalog
- [ ] Autobud i Tradera
- [ ] Skicka meddelande till säljare funktion
  - [ ] Ifall annonsen inte kan skickas, skicka ett meddelande till säljaren och
        fråga om den kan skickas
- [ ] Skapa bokföringsverifikation
...
- [ ] Få varning ifall en produkt har legat ute för länge och ifall det är dags
      att sänka priset

### Efter försäljning

- [ ] Avsluta annonser på alla marknadsplatser
- [ ] Registrera slutpris fraktkostnad i databasen
- [ ] Lösa fraktsedlar från postnord

### Övrigt

- [ ] Gör tillgänglig på begbot.simonbrundin.com
- [ ] Sidomenyn går inte att skrolla så vissa grejer syns inte
- [ ] Lös Mina annonser
- [ ] Göra så tiden scraping sessionen tagit syns på dialogloggen
- [ ] Kunna sortera /products på värderingsmetoder också
- [ ] Göra ett cron job som loopar igenom kolla när en produkt senast värderades
      och gör en ny värdering ifall det gått visst länge
- [ ] Vinstoptimeringssida
